...
using VDStudios.MagicEngine.Graphics.Veldrid.RenderTargets;
...
public abstract class DemoSceneBase : Scene
{
    ...
    {
        var manager = (VeldridGraphicsManager)Game.MainGraphicsManager;

        manager.GetOrCreateRenderTargetList(0).Add(new PassthroughRenderTarget(manager));
