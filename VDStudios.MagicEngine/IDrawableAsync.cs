...
/// <summary>
/// Represents a <see cref="Node"/> that can be drawn and can be added into the Draw Queue asynchronously. Takes precedence over <see cref="IDrawable"/> if both are implemented
/// </summary>
/// <remarks>
/// The actual draw operation is synchronous and is vital it remains so.
/// </remarks>
public interface IDrawableAsync
{
    /// <summary>
