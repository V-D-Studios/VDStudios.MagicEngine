...
///// <typeparam name="TGraphicsContext">The Graphics Context for the drawer</typeparam>
//public sealed class NodeDrawer<TGraphicsContext, TNode> : NodeDrawRegistrar 
//    where TNode : Node, IDrawableNode<TGraphicsContext>
